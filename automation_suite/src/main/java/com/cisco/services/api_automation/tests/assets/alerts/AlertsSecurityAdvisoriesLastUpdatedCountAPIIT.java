...
public class AlertsSecurityAdvisoriesLastUpdatedCountAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_security_advisories_last_updated_count";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/security-advisories/last-updated/count API 200 Response Validation")
