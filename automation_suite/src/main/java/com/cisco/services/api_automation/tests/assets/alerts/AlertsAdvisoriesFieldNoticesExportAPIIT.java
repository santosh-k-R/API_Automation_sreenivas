...
public class AlertsAdvisoriesFieldNoticesExportAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_advisories_field_notices_export";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/advisories-field-notices/export API 200 Response Validation")
