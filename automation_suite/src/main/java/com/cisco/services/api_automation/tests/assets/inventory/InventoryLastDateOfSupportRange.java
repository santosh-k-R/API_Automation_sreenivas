...
@Feature("Asset System LastDateOfSupportRange")
public class InventoryLastDateOfSupportRange extends BeforeTestSuiteClassIT{
	Response responseAPI = null;
	Response responseES = null;
	int expectedStatusCode = 200;
	String apiKey = "inventory_asset_system_lastdateofsupportrange";
	String endPoint;
