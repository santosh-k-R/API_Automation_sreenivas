...
public class TagPolicyMapping extends BeforeTestSuiteClassIT {
	...
	String apiKey="tag_policy_mapping";
	String endPoint;
	String table;
	...
	@Test(description = "/tags/v1/tag-policy-mapping-api API 200 Response Validation")
	...
	@Test(dependsOnMethods = { "api200ResponseValidation" },description = "/tags/v1/tag-policy-mapping-api Records Count Validation with DB")
