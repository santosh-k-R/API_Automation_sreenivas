...
public class AllAssetViewRoleDetails extends BeforeTestSuiteClassIT{
	...
	String apiKey="all_assets_view_role";
	String endPoint;
	...
	@Test(description = "/inventory/v1/all/assets/role/count API 200 Response Validation")
