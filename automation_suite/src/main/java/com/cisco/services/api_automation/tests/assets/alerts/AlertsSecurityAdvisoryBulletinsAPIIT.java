...
public class AlertsSecurityAdvisoryBulletinsAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_security_advisory_bulletins";
	String endPoint;
	String esIndex;
	String endPointHead;
    ...
    @Test(description = "/product-alerts/v1/security-advisory-bulletins API 200 Response Validation")
    ...
    @Test(description = "/product-alerts/v1/security-advisory-bulletins HEAD API 200 Response Validation")
