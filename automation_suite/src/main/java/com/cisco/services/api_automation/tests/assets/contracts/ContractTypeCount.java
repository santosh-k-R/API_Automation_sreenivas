...
public class ContractTypeCount extends BeforeTestSuiteClassIT {

	Response responseAPI = null;
	Response responseES = null;
	SoftAssert softAssert = new SoftAssert();
	String expectedStatusCode = "200";
	String apiKey = "contracts_type_device_count";
	String endPoint;
	String esIndex;
	...
	@Test(description = "/contracts/v1/type/device/count API 200 Response Validation")
	...
	@Test(dependsOnMethods = {
			"api200ResponseValidation" }, description = "/contracts/v1/type/device/count Data Validation with ES", groups = {
