...
public class AlertsFieldNoticesSummaryAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_field_notice_summary";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/field-notice/summary API 200 Response Validation")
