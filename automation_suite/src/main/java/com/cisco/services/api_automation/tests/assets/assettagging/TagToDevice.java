...
public class TagToDevice extends BeforeTestSuiteClassIT {
	...
	@Test(description = "/tags/v1/tag-to-device-api API 200 Response Validation")
	...
	@Test(dependsOnMethods = { "api200ResponseValidation" },description = "/tags/v1/tag-to-device-api Records Count Validation with DB")
