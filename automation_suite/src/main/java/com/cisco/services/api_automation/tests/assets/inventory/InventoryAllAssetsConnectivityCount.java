...
@Feature("All Asset Connctivity Count")
public class InventoryAllAssetsConnectivityCount extends BeforeTestSuiteClassIT {
		...
		String apiKey = "inventory_all_asset_connctivity_count";
		String endPoint;
