...
public class InventoryAssetsSystemProductTypeCount extends BeforeTestSuiteClassIT {

	Response responseAPI = null;
	Response responseES = null;
	SoftAssert softAssert = new SoftAssert();
	String expectedStatusCode = "200";
	String apiKey = "inventory_assets_system_productType_count";
	String endPoint;
	String esIndex;
	...
	@Test(description = "/inventory/v1/assets/system/productType/count API 200 Response Validation")
	...
	@Test(dependsOnMethods = {
			"api200ResponseValidation" }, description = "/inventory/v1/assets/system/productType/count Data Validation with ES", groups = {
