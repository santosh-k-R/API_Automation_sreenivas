...
public class AlertsSecurityAdvisoriesSupportCoverageAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_security_advisories_support_coverage";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/security-advisories/support-coverage API 200 Response Validation")
