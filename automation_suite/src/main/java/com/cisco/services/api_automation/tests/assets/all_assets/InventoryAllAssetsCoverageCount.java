...
@Feature("All Asset Coverage Count")
public class InventoryAllAssetsCoverageCount extends BeforeTestSuiteClassIT{
	
		Response responseAPI = null;
		Response responseES = null;
		int expectedStatusCode = 200;
		String apiKey = "inventory_all_asset_coverage_count";
		String endPoint;
