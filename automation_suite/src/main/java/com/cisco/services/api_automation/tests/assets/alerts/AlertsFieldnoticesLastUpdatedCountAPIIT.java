...
public class AlertsFieldnoticesLastUpdatedCountAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_field_notice_last_updated_count";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/field-notices/last-updated/count API 200 Response Validation")
