...
public class InventoryRoleDeviceCountAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "inventory_role_device_count";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/inventory/v1/role/device/count API 200 Response Validation")
