...
public class AlertsHardwareEOLTopCountAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_hardware_eol_top_count";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/hardware-eol/top/count API 200 Response Validation")
