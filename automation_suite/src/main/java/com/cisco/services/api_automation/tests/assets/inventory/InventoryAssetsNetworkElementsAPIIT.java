...
public class InventoryAssetsNetworkElementsAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
    ...
    @Test(description = "/inventory/v1/network-elements HEAD API 200 Response Validation")
