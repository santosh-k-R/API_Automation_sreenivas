...
public class AlertsSecurityAdvisoriesSeverityCountAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_security_advisories_severity_count";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/security-advisories/severity/count API 200 Response Validation")
