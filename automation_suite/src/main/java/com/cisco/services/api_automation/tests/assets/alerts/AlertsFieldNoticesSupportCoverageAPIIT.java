...
public class AlertsFieldNoticesSupportCoverageAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_field_notices_support_coverage";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/field-notices/support-coverage API 200 Response Validation")
