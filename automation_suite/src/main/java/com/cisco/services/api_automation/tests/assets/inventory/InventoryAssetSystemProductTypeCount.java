...
@Feature("Asset System Product Type Count")
public class InventoryAssetSystemProductTypeCount extends BeforeTestSuiteClassIT{
	Response responseAPI = null;
	Response responseES = null;
	int expectedStatusCode = 200;
	String apiKey = "inventory_asset_system_producttype_count";
	String endPoint;
