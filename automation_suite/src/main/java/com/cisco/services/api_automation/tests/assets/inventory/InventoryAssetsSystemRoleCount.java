...
@Feature("Asset System Role Count")
public class InventoryAssetsSystemRoleCount extends BeforeTestSuiteClassIT{
	Response responseAPI = null;
	Response responseES = null;
	int expectedStatusCode = 200;
	String apiKey = "inventory_asset_system_role_count";
	String endPoint;
