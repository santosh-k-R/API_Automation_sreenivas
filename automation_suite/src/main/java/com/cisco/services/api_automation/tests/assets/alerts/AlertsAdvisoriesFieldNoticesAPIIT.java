...
public class AlertsAdvisoriesFieldNoticesAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_advisories_field_notices";
	String endPoint;
	String esIndex;
	String endPointHead;
    ...
    @Test(description = "/product-alerts/v1/advisories-field-notices API 200 Response Validation")
    ...
    @Test(description = "/product-alerts/v1/advisories-field-notices HEAD API 200 Response Validation")
