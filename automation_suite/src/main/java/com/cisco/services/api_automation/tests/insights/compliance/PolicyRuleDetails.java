...
import com.cisco.services.api_automation.pojo.response.compliance.PolicyRuleDetailPOJO;
import com.cisco.services.api_automation.testdata.insights.compliance.PolicyRuleDetailsData;
...
public class PolicyRuleDetails {
    ...
    @Test(dataProviderClass = PolicyRuleDetailsData.class, dataProvider = "getUnAuthorizedRequestData")
    ...
    @Test(dataProviderClass = PolicyRuleDetailsData.class, dataProvider = "getBadRequestData")
...
//    @Test(dataProviderClass = PolicyRuleDetailsData.class, dataProvider = "getAllData")
...
//    @Test(dataProviderClass = PolicyRuleDetailsData.class, dataProvider = "getUseCaseData")
...
//    @Test(dataProviderClass = PolicyRuleDetailsData.class, dataProvider = "getEmptyResponseData")
    ...
    public void validateResponse(String endPoint, String headers, String params, String user, String esQuery, String esIndex) {
        ...
        PolicyRuleDetailPOJO responseBody = response.as(PolicyRuleDetailPOJO.class, ObjectMapperType.JACKSON_2);
