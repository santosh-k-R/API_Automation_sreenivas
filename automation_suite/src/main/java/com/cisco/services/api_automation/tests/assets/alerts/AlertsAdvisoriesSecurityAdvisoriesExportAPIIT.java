...
public class AlertsAdvisoriesSecurityAdvisoriesExportAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_advisories_security_advisories_export";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/advisories-security-advisories/export API 200 Response Validation")
