...
public class InventoryAssetsVulerabilitiesCountDetails extends BeforeTestSuiteClassIT {
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "inventory_assets_vulnerabilities";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/inventory/v1/assets/vulnerabilities/count API 200 Response Validation")
