...
public class AlertsHardwareEOLSummaryAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
    ...
    @Test(description = "/product-alerts/v1/hardware-eol/summary API 200 Response Validation")
