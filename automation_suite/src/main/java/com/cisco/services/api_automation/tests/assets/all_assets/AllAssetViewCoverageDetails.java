...
public class AllAssetViewCoverageDetails extends BeforeTestSuiteClassIT{
	...
	String apiKey="all_assets_view_coverage";
	String endPoint;
	...
	@Test(description = "/inventory/v1/all/assets/coverage/count API 200 Response Validation")
