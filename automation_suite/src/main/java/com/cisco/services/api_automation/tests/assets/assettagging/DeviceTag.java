...
public class DeviceTag extends BeforeTestSuiteClassIT {
	...
	@Test(description = "/tags/v1/device-tag-api API 200 Response Validation")
	public void api200ResponseValidation() throws Exception {
		...
		try {
			...
			commonTestAcrossAPIsIT.invokeDeviceTagAPIsAndValidateResponseCodeAndResponseTime(apiKey, endPoint);
	...
	@Test(dependsOnMethods = { "api200ResponseValidation" },description = "/tags/v1/device-tag-api Records Count Validation with DB")
	public void apiRecordsCountValidation( ) {
		...
		try {
			CommonTestAcrossAPIsIT commonTestAcrossAPIsIT = new CommonTestAcrossAPIsIT();
			apiRecordsCount = commonTestAcrossAPIsIT.recordsCountForDeviceTagAPI(apiKey, endPoint);
