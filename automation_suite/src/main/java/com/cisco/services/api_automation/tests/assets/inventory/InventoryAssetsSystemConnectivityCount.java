...
@Feature("Asset System Connectivity Count")
public class InventoryAssetsSystemConnectivityCount extends BeforeTestSuiteClassIT{
	Response responseAPI = null;
	Response responseES = null;
	int expectedStatusCode = 200;
	String apiKey = "inventory_asset_system_connectivity_count";
	String endPoint;
