...
public class AlertsVulnerabilitiesCountAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_vulnerabilities_count";
	String endPoint;
	String esIndex;
    ...
    @Test(description = "/product-alerts/v1/vulnerabilities/count API 200 Response Validation")
