...
public class AlertsFieldNoticesBulletinsAPIIT extends BeforeTestSuiteClassIT{
...
//	String customerId = AssetsData.CUSTOMERID;
	...
	String apiKey = "product_alerts_field_notice_bulletins";
	String endPoint;
	String esIndex;
	String endPointHead;
    ...
    @Test(description = "/product-alerts/v1/field-notic-bulletins API 200 Response Validation")
    ...
    @Test(description = "/product-alerts/v1/field-notic-bulletins HEAD API 200 Response Validation")
